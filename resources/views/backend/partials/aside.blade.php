<aside class="left-sidebar bg-sidebar">
    <div id="sidebar" class="sidebar sidebar-with-footer">
      <!-- Aplication Brand -->
      <div class="app-brand">
        <a href="/index.html" title="Amir Sohel Akash">
          <img src="{{ asset('backend/upload/akash.jpg') }}" alt="" srcset="">

          <span class="brand-name text-truncate">Peace</span>
        </a>
      </div>
        ...
        <ul class="nav sidebar-inner" id="sidebar-menu">
              ...
              <div class="sub-menu">
                <li class="active">
                  <a class="sidenav-item-link" href="index.html">
                    <span class="nav-text">About The Owner</span>
                  </a>
                </li>

                <li class="">
                  <a class="sidenav-item-link" href="analytics.html">
                    <span class="nav-text">Are You Ready?</span>
          ...
          <li class="has-sub ">
            ...
            <ul class="collapse " id="app" data-parent="#sidebar-menu">
              <div class="sub-menu">
                <li class="">
                  <a class="sidenav-item-link" href="{{ route('add.member') }}">
